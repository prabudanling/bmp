...
const ACCORDION: { q: string; steps: string[] }[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      'Pasang ikon tab browser lewat kartu "Favicon Website" — jika dikosongkan, favicon otomatis mengikuti logo perusahaan.',
      'Klik "Simpan Pengaturan" untuk data teks; logo & favicon tersimpan otomatis setelah diunggah.',
